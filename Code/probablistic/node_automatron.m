        ...
        case 1 %Rest
           act_path=1;
            ...
            for i=1:length(path_ind)
                    temp=round(normrnd(0,6,1,1));
                    if temp+path_table{path_ind(i),9}<1
                        temp=1-path_table{path_ind(i),9};
                    end
                    path_table{path_ind(i),5}=path_table{path_ind(i),9}+temp;
                    path_table{path_ind(i),6}=path_table{path_ind(i),9}+temp;
                    path_table{path_ind(i),7}=path_table{path_ind(i),9}+temp;
                    path_table{path_ind(i),8}=path_table{path_ind(i),9}+temp;
            end
        ...
        case 3 %RRP
            ...
            for i=1:length(path_ind)
                ...
                if node_type=='AV'
                        ...
                        path_table{path_ind(i),6}=round(path_table{path_ind(i),9}*(1+ratio*3))+temp;
                        if path_table{path_ind(i),6}<1
                            path_table{path_ind(i),6}=1;
                        end
